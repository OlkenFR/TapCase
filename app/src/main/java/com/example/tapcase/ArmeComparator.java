...
public class ArmeComparator {
    ...
    public static Comparator<Arme> getPrixComparator(boolean ascending) {
        return new Comparator<Arme>() {
            @Override
            public int compare(Arme arme1, Arme arme2) {
                int result = Integer.compare(arme1.getPrix(), arme2.getPrix());
                return ascending ? result : -result;
            }
        };
    }

    public static Comparator<Arme> getRareteComparator(boolean ascending) {
        return new Comparator<Arme>() {
            @Override
            public int compare(Arme arme1, Arme arme2) {
                int result = arme1.getRarete().compareTo(arme2.getRarete());
                return ascending ? result : -result;
            }
        };
    }

    public static Comparator<Arme> getFleursTirComparator(boolean ascending) {
        return new Comparator<Arme>() {
            @Override
            public int compare(Arme arme1, Arme arme2) {
                int result = Integer.compare(arme1.getFlower_per_click(), arme2.getFlower_per_click());
                return ascending ? result : -result;
            }
        };
    }

    public static Comparator<Arme> getNomComparator(boolean ascending) {
        return new Comparator<Arme>() {
            @Override
            public int compare(Arme arme1, Arme arme2) {
                ...
                if (typeCompare == 0) {
                    int result = arme1.getNom().compareTo(arme2.getNom());
                    return ascending ? result : -result;
                }
